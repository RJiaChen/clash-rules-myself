...
const foreignNameservers = [
  ...
  // "https://one.one.one.one/dns-query", // CloudflareDNS
...
const ruleProviders = {
  ...
  "microsoft": {
    ...ruleProviderCommon,
    "behavior": "domain",
    "url": "https://cdn.jsdelivr.net/gh/RJiaChen/clash-rules-myself/microsoft.txt",
...
const rules = [
  ...
  "DOMAIN-KEYWORD,1drv,🥵 巨硬服务",
  "DOMAIN-KEYWORD,microsoft,🥵 巨硬服务",
  "DOMAIN-KEYWORD,onedrive,🥵 巨硬服务",
  "DOMAIN-KEYWORD,skydrive,🥵 巨硬服务",
  "PROCESS-NAME,onedrive,🥵 巨硬服务",
  "PROCESS-NAME,onedriveupdater,🥵 巨硬服务",
  // Loyalsoldier 规则集
